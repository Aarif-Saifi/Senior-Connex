...
export default function DoctorList() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            // const res = await fetch("http://staging.admin.seniorconnex.com/user/patientList",
            ...
            const myData = res.result.reverse();
                ...
                <TableContainer component={Paper} style={{ marginTop: "0px" }}>
                    ...
                    <Table className={classes.table}>
                        ...
                        <div class="header" style={{marginTop:"0px"}}>
                            <Link to="/doctorhome"><KeyboardBackspaceIcon style={{marginTop:"70px",marginLeft:"100px", height:"40px", width:"40px"}} /></Link>
                        ...
                        <TableBody>
                            {
                                ...
                                // rows.map((row) => (
                                    ...
                                    <TableRow key={row._id} className={classes.row}>
                                        ...
                                        <TableCell align="center" className={getColorClass("heartRate", row.heartRate)}>{row.heartRate ==null? "-":<Link to="/adminchart" > {row.heartRate}</Link>}</TableCell>
                                        <TableCell align="center"><Link to="/adminoxygen">90</Link></TableCell>
                                        <TableCell align="center" className={getColorClass("ecg", "Normal")}><Link to="/adminecg">Normal</Link></TableCell>
                                        <TableCell align="center" className={getColorClass("bloodPressure", "156/98")}><Link to="/adminpressure">156/98</Link></TableCell>
